...
''',
        ...
        'ocr_text': "OCR文本 (可编辑):",
        'ocr_instructions': "使用鼠标左键拖动选择屏幕区域进行OCR。按ESC键取消。",
        'ocr_success': "OCR 完成！",
        'ocr_error': "OCR 失败",
        ...
        'screenshot_instructions': "使用鼠标左键拖动选择屏幕区域进行截图。按ESC键取消。",
...
''',
        ...
        'ocr_instructions': "Click and drag the left mouse button to select a screen area for OCR. Press ESC to cancel.",
        ...
        'screenshot_instructions': "Click and drag the left mouse button to select a screen area for screenshot. Press ESC to cancel.",
